...
def get_args_parser():
    ...
    # dataset parameters
    parser.add_argument('--dataset_file', default='city2foggy_source')
    parser.add_argument('--coco_path', default='./data', type=str)
    parser.add_argument('--coco_panoptic_path', type=str)
    parser.add_argument('--remove_difficult', action='store_true')

    parser.add_argument('--output_dir', default='./exps/source_model',
                        help='path where to save, empty for no saving')
    parser.add_argument('--device', default='cuda',
                        help='device to use for training / testing')
    parser.add_argument('--seed', default=42, type=int)
    parser.add_argument('--resume', default='', help='resume from checkpoint')
    parser.add_argument('--checkpoint', default='./best.pth', help='resume from checkpoint')
